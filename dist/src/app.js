...
import { getPantryItemsByUser, getUserProfile, getUserSettings, removePantryItem, setUserProfile, updatePantryItem, upsertUserSettings } from "./data/store.js";
...
import { dinnerRecommendationRequestSchema, marketSchema, pantryItemInputSchema, pantryItemUpdateSchema, shoppingListRequestSchema, userProfileUpdateSchema, userSettingsUpsertSchema } from "./types/schemas.js";
...
export function createApp() {
    ...
    function createDefaultProfile(userId, market, timezone) {
        return {
            id: userId,
    ...
    app.put("/users/me/profile", (req, res, next) => {
        try {
            ...
            const existing = getUserProfile(payload.userId) ??
                createDefaultProfile(payload.userId, market, payload.timezone ?? MARKET_CONFIG[market].defaultTimezone);
            const nextProfile = {
                ...existing,
                ...payload,
                id: payload.userId
