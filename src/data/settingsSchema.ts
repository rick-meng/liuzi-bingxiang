import type { SettingsSchemaResponse, SettingsValues } from "../types/domain.js";

export const SETTINGS_SCHEMA: SettingsSchemaResponse = {
  sections: [
    {
      key: "language_region",
      labels: {
...
export function buildDefaultSettingsValues(): SettingsValues {
